On July 13, 2014, Jeremy Williams wrote:
NOTE: This library was edited for compatibility with SdFat and 
to reduce memory usage. Some networking functionality has 
been disabled. The original library can be found here:
